            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="row">
                            <div class="col-sm-3">
                                <input type="text" name="cari" class="form-control" id="search" placeholder="Cari Nama Region...">
                            </div>
                            <div class="col-sm-2">
                    ...
                    <div class="col-md-2">
                        @if (hakAksesMenu('region','create'))
                            {!! xButton('/region/create', 'tambah_view', 'Buat Region') !!}
                        @endif
                    </div>
                </div>
