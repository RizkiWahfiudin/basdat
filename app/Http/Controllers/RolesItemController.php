...
class RolesItemController extends Controller
{
    ...
    public function store(Request $r)
    {
        ...
        try {
            ...
            activity()->log('Role Item: '.$r->nama.' ditambahkan');
    ...
    public function update(Request $r, RolesItem $rolesitem)
    {
        ...
        activity()->log('Role Item: '.$rolesitem->nama.' diperbarui menjadi '.$r->nama);
    ...
    {
        $rolesitem = RolesItem::find($id)->nama;

        try {
            RolesItem::where('id', $id)->delete();
            activity()->log('Roles Item: '.$rolesitem.' dihapus');
